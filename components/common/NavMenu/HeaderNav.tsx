...
export const HeaderNav = () => {
  ...
  return (
    <div className={`fixed bg-[#175873] h-20 w-full z-20 flex items-center justify-between px-6 ${showHeader ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`}>
